          ...
          <div class="col-md-9">
            <div class="card card-primary card-outline">
              ...
              <!-- /.card-header -->
                ...
                <form role="form" id="quickForm" method="POST" action="{{route('artical.store')}}"
                  ...
                  <div class="card-body">
                    ...
                    <option value="{{$item->id}}" >{{$item->name_en}}</option>
                      ...
                      <div class="form-group">
                        ...
                        <textarea class="form-control" name='shortDesc' value="{{old('shortDesc')}}" rows="3" placeholder="Enter ..."></textarea>
                      </div>
                    </div>
                    </div>
                    
                    <textarea id="compose-textarea" class="form-control" name="body" value="{{old('body')}}"  style="height: 300px">
